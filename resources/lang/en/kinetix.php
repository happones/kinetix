...
return [
    ...
    'import_dropzone_hint'              => 'Drop your file here, or choose one',
    'import_dropzone_formats'           => 'CSV, TSV, XLS or XLSX · up to :size',
    'import_remove_file'                => 'Remove file',
    'import_parse_options'              => 'Reading options',
    'import_parse_options_help'         => 'These only affect how the file is read — change them if the preview looks wrong.',
    'import_reparse'                    => 'Re-read file',
    'import_delimiter_comma'            => 'Comma ( , )',
    'import_delimiter_semicolon'        => 'Semicolon ( ; )',
    'import_delimiter_tab'              => 'Tab',
    'import_delimiter_pipe'             => 'Pipe ( | )',
    'import_enclosure_double'           => 'Double quote ( " )',
    'import_enclosure_single'           => 'Single quote ( \' )',
    'import_enclosure_none'             => 'None',
    'import_has_header_short'           => 'with header row',
    'import_no_header_short'            => 'no header row',
    'import_skipped_lines_short'        => ':count lines omitted',
    'import_back'                       => 'Back',
    'import_continue'                   => 'Continue',
    'import_mapping_search'             => 'Search fields',
    'import_mapping_unmapped_only'      => 'Unmapped only',
    'import_mapping_reset'              => 'Reset to suggestions',
    'import_mapping_progress'           => ':mapped of :total fields mapped',
    'import_mapping_missing_required'   => ':count required fields still unmapped',
    'import_mapping_no_matches'         => 'No field matches your search.',
    ...
    'import_preview_caption'            => 'Sample rows from the uploaded file, with the field each column is mapped to.',
    'import_preview_row_heading'        => 'Row',
    'import_preview_ignored'            => 'ignored',
    'import_preview_empty'              => 'The file has no data rows to preview.',
    'import_summary_file'               => 'File',
    'import_summary_rows'               => 'Rows',
    'import_summary_mapped'             => 'Mapped fields',
    'import_summary_ignored'            => 'Ignored columns',
    'import_queued_help'                => 'The import runs in the background. You will be notified when it finishes, with a list of any rows that were skipped.',
    'import_parsed_announce'            => 'File read: :rows rows and :columns columns detected.',
    ...
    'announcements_manage_title'         => 'Announcements',
    'announcements_new_entry'            => 'New announcement',
    'announcements_empty_hint'           => 'Publish your first update — it lands in everyone\'s “What’s new” feed.',
    ...
    'announcements_global_readonly'      => 'Platform-wide — edit it outside a team',
    'announcements_field_title'          => 'Title',
    'announcements_field_body'           => 'Message',
    'announcements_field_level'          => 'Level',
    'announcements_field_published_at'   => 'Publish at',
    'announcements_field_published_hint' => 'Leave empty to keep it a draft; a future date schedules it.',
    'announcements_field_expires_at'     => 'Expires at',
    ...
    'spotlight_searching'   => 'Searching…',
    'spotlight_min_chars'   => 'Type at least :count characters',
