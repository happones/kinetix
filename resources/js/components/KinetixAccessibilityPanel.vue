...
const toggles: { key: keyof KinetixAccessibility; label: string; help: string }[] = [
  { key: "reducedMotion", label: "a11y_reduced_motion", help: "a11y_reduced_motion_help" },
  { key: "highContrast", label: "a11y_high_contrast", help: "a11y_high_contrast_help" },
  { key: "underlineLinks", label: "a11y_underline_links", help: "a11y_underline_links_help" },
  { key: "enhancedFocus", label: "a11y_enhanced_focus", help: "a11y_enhanced_focus_help" },
];

const textSizes: KinetixAccessibility["textSize"][] = ["normal", "large", "x-large"];
const textSizeLabel = { normal: "a11y_text_normal", large: "a11y_text_large", "x-large": "a11y_text_x_large" } as const;
</script>
...
<template>
  <div class="space-y-6">
    ...
    <fieldset class="space-y-2">
      ...
      <div class="flex gap-2" role="radiogroup" :aria-label="t('kinetix.a11y_text_size')">
        <button
