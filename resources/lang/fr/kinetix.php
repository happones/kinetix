...
return [
    ...
    'import_step_mapping'               => 'Correspondance',
    'import_step_review'                => 'Vérifier',
    'import_dropzone_hint'              => 'Déposez votre fichier ici ou choisissez-en un',
    'import_dropzone_formats'           => 'CSV, TSV, XLS ou XLSX · jusqu’à :size',
    'import_remove_file'                => 'Retirer le fichier',
    'import_parse_options'              => 'Options de lecture',
    'import_parse_options_help'         => 'Elles n’affectent que la lecture du fichier — modifiez-les si l’aperçu semble incorrect.',
    'import_reparse'                    => 'Relire le fichier',
    'import_delimiter_comma'            => 'Virgule ( , )',
    'import_delimiter_semicolon'        => 'Point-virgule ( ; )',
    'import_delimiter_tab'              => 'Tabulation',
    'import_delimiter_pipe'             => 'Barre verticale ( | )',
    'import_enclosure_double'           => 'Guillemet double ( " )',
    'import_enclosure_single'           => 'Guillemet simple ( \' )',
    'import_enclosure_none'             => 'Aucun',
    'import_has_header_short'           => 'avec ligne d’en-tête',
    'import_no_header_short'            => 'sans ligne d’en-tête',
    'import_skipped_lines_short'        => ':count lignes ignorées',
    'import_back'                       => 'Retour',
    'import_continue'                   => 'Continuer',
    'import_mapping_search'             => 'Rechercher des champs',
    'import_mapping_unmapped_only'      => 'Non associés seulement',
    'import_mapping_reset'              => 'Rétablir les suggestions',
    'import_mapping_progress'           => ':mapped champs sur :total associés',
    'import_mapping_missing_required'   => ':count champs obligatoires non associés',
    'import_mapping_no_matches'         => 'Aucun champ ne correspond à votre recherche.',
    ...
    'import_preview_caption'            => 'Lignes d’exemple du fichier téléversé, avec le champ associé à chaque colonne.',
    'import_preview_row_heading'        => 'Ligne',
    'import_preview_ignored'            => 'ignorée',
    'import_preview_empty'              => 'Le fichier n’a aucune ligne de données à prévisualiser.',
    'import_summary_file'               => 'Fichier',
    'import_summary_rows'               => 'Lignes',
    'import_summary_mapped'             => 'Champs associés',
    'import_summary_ignored'            => 'Colonnes ignorées',
    'import_queued_help'                => 'L’import s’exécute en arrière-plan. Vous serez notifié à la fin, avec la liste des lignes ignorées.',
    'import_parsed_announce'            => 'Fichier lu : :rows lignes et :columns colonnes détectées.',
    ...
    'business_hours_remove_range'    => 'Supprimer les horaires',
    'business_hours_apply_all'       => 'Appliquer à tous les jours',
    'business_hours_closed'          => 'Fermé',
    ...
    'announcements_level_feature'        => 'Nouveauté',
    'announcements_level_fix'            => 'Correctif',
    'announcements_previous'             => 'Annonce précédente',
    'announcements_next'                 => 'Annonce suivante',
    'announcements_dismiss'              => 'Ignorer',
    'announcements_pause'                => 'Mettre en pause le défilement',
    ...
    'announcements_manage_title'         => 'Annonces',
    'announcements_new_entry'            => 'Nouvelle annonce',
    'announcements_empty_hint'           => 'Publiez votre première nouveauté — elle apparaîtra dans le fil « Nouveautés » de chacun.',
    'announcements_status_draft'         => 'Brouillon',
    'announcements_status_scheduled'     => 'Programmée',
    'announcements_status_published'     => 'Publiée',
    'announcements_global'               => 'Plateforme',
    ...
    'help_translation_missing'    => 'Cet article n\'est pas encore traduit — voici la version en :language.',
    'help_read_in'                => 'Lire en',
    'help_untranslated'           => 'Pas encore traduit',
    ...
    'member_email'                => 'E-mail',
    'member_username'             => "Nom d'utilisateur",
    ...
    'spotlight_searching'   => 'Recherche…',
    'spotlight_min_chars'   => 'Saisissez au moins :count caractères',
