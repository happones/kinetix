...
/**
 * ISO 3166-1 alpha-2 country list (code => English name). Used as the default
 * option set for the AddressPicker country select; override per-field with
 * AddressPicker::countries([...]).
 */
class Countries
{
    /**
