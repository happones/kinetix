...
/**
 * ISO 3166-1 alpha-2 country code => ITU-T E.164 calling code (digits only,
 * without the leading "+"). Used by the PhoneInput field to prefix numbers and
 * build the country selector. Pair with {@see Countries} for country names.
 */
class DialCodes
{
    /**
    ...
    public static function all(): array
    {
        return [
            ...
            'CA' => '1', 'CV' => '238', 'KY' => '1', 'CF' => '236', 'TD' => '235', 'CL' => '56',
    ...
    {
        return static::all()[strtoupper($country)] ?? null;
    }
}
