    ...
    <PopoverRoot v-else v-model:open="open">
        ...
        <PopoverPortal>
            <PopoverContent
                align="start"
                :side-offset="4"
                class="p-0 shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 z-50 w-auto rounded-md border border-border bg-popover outline-none"
            >
                <div class="sm:flex">
                    <KinetixCalendar
                        class="border-0"
