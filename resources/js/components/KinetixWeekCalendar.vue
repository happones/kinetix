...
<template>
  <CalendarRoot
    ...
    :week-starts-on="(weekStartsOn as 0 | 1 | 2 | 3 | 4 | 5 | 6)"
          ...
          >
            ...
            >
              <CalendarCellTrigger
                ...
                :class="
                  cn(
                    'flex h-8 w-8 items-center justify-center rounded-md text-sm text-foreground hover:bg-accent data-[outside-view]:text-muted-foreground/50 data-[disabled]:opacity-40',
                    inWeek(weekDate) && 'bg-primary text-primary-foreground hover:bg-primary',
                  )
                "
              />
            </CalendarCell>
