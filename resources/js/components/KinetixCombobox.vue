    ...
    >
        ...
        <ComboboxPortal>
            <ComboboxContent
                position="popper"
                :side-offset="4"
                class="max-h-96 shadow-md relative z-[var(--kinetix-z-popover,120)] w-[--reka-combobox-trigger-width] min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover text-popover-foreground"
            >
