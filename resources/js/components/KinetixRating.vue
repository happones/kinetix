...
<template>
  ...
  >
    <button
      ...
      type="button"
      :disabled="disabled"
      class="relative text-amber-400 transition-transform hover:scale-110 disabled:pointer-events-none"
      :aria-label="`${i}`"
    ...
    >
      ...
      <StarHalf
        ...
        class="absolute inset-0 size-6 fill-amber-400 text-amber-400"
      />
    </button>
  </div>
</template>
