...
export const specimens: Specimen[] = [
                ...
                events: [
                    {
                        ...
                        start: '2026-06-04T00:00:00+00:00',
                        end: null,
                        allDay: true,
                        color: '#22c55e',
                        url: null,
    ...
    {
        name: 'event-calendar-week',
        title: 'Event calendar — week view',
        component: KinetixEventCalendar,
        frame: 'card',
        width: 860,
        props: {
    ...
    {
        name: 'event-calendar-day',
        title: 'Event calendar — day view',
        component: KinetixEventCalendar,
        frame: 'card',
        width: 620,
        props: {
    ...
    {
        name: 'event-calendar-details',
        title: 'Event calendar — event details popup',
        component: KinetixEventCalendar,
        frame: 'card',
        width: 860,
        openSelector: '#specimen button:has-text("Client call")',
        props: {
            locale: 'en-US',
            anchorDate: '2026-06-10',
            calendar: {
                ...
                events: [
                    {
                        ...
                        actions: [
                            ...
                            },
                            {
                                ...
                                shouldMarkAsUnread: false,
                                requiresConfirmation: true,
                                modalHeading: 'Delete this event?',
                                url: '/events/1',
